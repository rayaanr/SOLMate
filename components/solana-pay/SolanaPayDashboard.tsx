...
export function SolanaPayDashboard({
  ...
  const handlePaymentComplete = useCallback(
    (signature: string, amount: number, token?: string) => {
      ...
      <div className="space-y-4">
        ...
        {(() => {
          const tokenSymbol = viewingPayment.token
            ? MINT_TO_SYMBOL_MAP[viewingPayment.token] ?? "SPL"
            : "SOL";
          const splToken =
            viewingPayment.token && MINT_TO_SYMBOL_MAP[viewingPayment.token]
    ...
    <div className="space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          Fund your wallet instantly with QR codes and deep links. Compatible
          with all major Solana wallets including Phantom, Solflare, and more.
        </p>
      </div>
